      ...
      <Page size="A4" style={s.page}>
            ...
            <View style={s.condRow} wrap={false}>
              ...
              {orcamento.tempoGarantia ? (
                <View style={s.condCard}>
                  ...
                  <Text style={[s.condValue, { fontFamily: "Helvetica-Bold", color: corDestaque }]}>
                    {orcamento.tempoGarantia}
                  </Text>
                  {orcamento.garantia ? (
                    <Text style={[s.condValue, { marginTop: 2 }]}>{orcamento.garantia}</Text>
                  ) : null}
                </View>
              ) : null}
            </View>
        ...
        <View style={s.sigSection} wrap={false}>
          ...
          <Text style={s.sigDescription}>
            Confirmando o aceite desta proposta, as partes declaram estar de acordo com o escopo, condições comerciais e
            valores apresentados neste documento.
          </Text>
          <View style={s.sigRow}>
        ...
        <View style={s.footer} fixed>
          <View style={s.footerLeft}>
            ...
            <Text style={s.footerContact}>{[enderecoEmpresa, telefone, email].filter(Boolean).join(" · ")}</Text>
          </View>
