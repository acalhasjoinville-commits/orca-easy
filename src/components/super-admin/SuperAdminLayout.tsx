...
import { LayoutDashboard, Building2, Users, Mail, ScrollText, LogOut, Shield, ChevronLeft } from "lucide-react";
...
const navItems: Array<{ tab: SATab; label: string; icon: LucideIcon }> = [
    ...
    <div className="min-h-screen flex w-full bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-14 flex items-center border-b bg-card/80 backdrop-blur-sm px-5 shrink-0 sticky top-0 z-40">
          ...
          <h1 className="text-sm font-semibold text-foreground flex-1">Administracao da Plataforma</h1>
