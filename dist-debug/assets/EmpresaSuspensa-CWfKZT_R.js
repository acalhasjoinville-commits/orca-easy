...
function EmpresaSuspensa() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "max-w-sm w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-8 text-center space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "h-16 w-16 text-destructive mx-auto" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: isBloqueada ? "Conta Bloqueada" : "Conta Suspensa" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "A empresa vinculada à sua conta ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: user == null ? void 0 : user.email }),
      " ",
      "está ",
      isBloqueada ? "bloqueada" : "suspensa",
      "."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: isBloqueada ? "Entre em contato com o suporte da plataforma para mais informações." : "Entre em contato com o administrador da plataforma para reativação." }),
